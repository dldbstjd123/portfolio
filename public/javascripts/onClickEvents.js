...
function slideToLeft(company) {
    ...
    widthOfExperienceImage = document.getElementsByClassName(
        "experienceImages"
    )[0].clientWidth
    console.log(widthOfExperienceImage)
    if (company == 0) {
        position += widthOfExperienceImage
        document.getElementById("experienceImageContainer1").style.left =
            position + "px"
        if (position == widthOfExperienceImage) {
            changeTransition(
                document.getElementById("experienceImageContainer1").style,
                "left 0"
            )
            document.getElementById("experienceImageContainer1").style.left =
                -2 * widthOfExperienceImage + "px"
            position = -2 * widthOfExperienceImage
        }
    }
    if (company == 2) {
        position2 += widthOfExperienceImage
        document.getElementById("experienceImageContainer3").style.left =
            position2 + "px"
        if (position2 == widthOfExperienceImage) {
            changeTransition(
                document.getElementById("experienceImageContainer3").style,
                "left 0"
            )
            document.getElementById("experienceImageContainer3").style.left =
                -2 * widthOfExperienceImage + "px"
...
function resetDotColor(company) {
    ...
    if (company == 0) {
        document.getElementById(
            "experienceLocationMysuit1"
        ).style.backgroundColor = "#bbb"
        document.getElementById(
            "experienceLocationMysuit2"
        ).style.backgroundColor = "#bbb"
        document.getElementById(
            "experienceLocationMysuit3"
        ).style.backgroundColor = "#bbb"
        switch (position) {
            case 0:
                document.getElementById(
    ...
    if (company == 2) {
        document.getElementById("experienceLocationUA1").style.backgroundColor =
            "#bbb"
        document.getElementById("experienceLocationUA2").style.backgroundColor =
            "#bbb"
        document.getElementById("experienceLocationUA3").style.backgroundColor =
            "#bbb"
        switch (position2) {
            case 0:
                document.getElementById(
                    "experienceLocationUA1"
                ).style.backgroundColor = "#2a26ff"
                break
            case -widthOfExperienceImage:
                document.getElementById(
                    "experienceLocationUA2"
                ).style.backgroundColor = "#2a26ff"
                break
            case -2 * widthOfExperienceImage:
                document.getElementById(
                    "experienceLocationUA3"
                ).style.backgroundColor = "#2a26ff"
                break
        }
    }
...
function inputClicked(input) {
    ...
    document.getElementsByClassName("contactLabel")[input].style.fontSize =
        "15px"
...
function inputOut(input) {
    if (
        input == 0 &&
        document.getElementsByClassName("inputContainer")[input].children[0]
            .value == ""
    ) {
        document.getElementsByClassName("contactLabel")[input].style.top =
            "10px"
        document.getElementsByClassName("contactLabel")[input].style.fontSize =
            "25px"
        document.getElementsByClassName("contactLabel")[input].style.color =
            "black"
    }
    if (
        input == 1 &&
...
function validateForm() {
    let name = document.getElementsByClassName("inputContainer")[0].children[0]
        .value
    let email = document.getElementsByClassName("inputContainer")[1].children[0]
        .value
    let message = document.getElementsByClassName("inputContainer")[2]
        .children[0].value
    if (name.length < 1) {
        document.getElementsByClassName("inputContainer")[0].children[0].focus()
        document.getElementsByClassName("contactLabel")[0].innerHTML =
            "Please Insert Name"
    } else if (email.length < 1) {
        document.getElementsByClassName("inputContainer")[1].children[0].focus()
        document.getElementsByClassName("contactLabel")[1].innerHTML =
            "Please Insert Email"
        ...
        document.getElementsByClassName("contactLabel")[2].innerHTML =
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == "succeed") {
                    document.getElementById(
                        "contactFormAfterSubmit"
                    ).innerHTML = "Thank you!, Your message has been received."
                    ...
                    document.getElementById(
                        "contactFormAfterSubmit"
                    ).innerHTML = "Sorry, please try it again later."
                }
            },
            dataType: "json"
        })

...
function onLoad() {
    topLayoutHeight =
        document.getElementById("topLayout").clientHeight +
        document.getElementById("topBar").clientHeight
    aboutSectionHeight =
        document.getElementById("aboutSection").clientHeight +
        document.getElementById("moreToExperience").clientHeight
    experienceSectionHeight = document.getElementById("experienceSection")
        .scrollHeight
    skillsSectionHeight = document.getElementById("skillsSection").scrollHeight
    contactSectionHeight = document.getElementById("contactSection")
        .scrollHeight
    ...
    document.getElementById("bodyWrapper").style.marginRight =
        document.getElementById("leftLayout").clientWidth + "px"
...
window.addEventListener("resize", function (event) {
    if (document.body.clientWidth < 750) {
        ...
        document.getElementById(
            "bodyWrapper"
        ).style.marginRight = document.getElementById("leftLayout").clientWidth
    }
...
function nameEffect() {
    setInterval(function () {
        for (
            let i = 0;
            i < document.getElementById("myName").childElementCount;
            i++
        ) {
            setTimeout(function () {
                document.getElementById("myName").children[i].style.bottom =
                    "15px"
            }, i * 100)
        }
        for (
...
function moreEffect() {
    setTimeout(function () {
        ...
        setInterval(function () {
            document.getElementById("moreIcon").style.transform =
                "rotate(360deg)"
            setTimeout(function () {
                document.getElementById("moreIcon").style.transform =
                    "rotate(0deg)"
    ...
    setTimeout(function () {
        ...
        document.getElementById("aboutCode").style.transform =
            "rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutCode").style.webkitTransform =
            "rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutFoundation").style.opacity = "90"
        document.getElementById("aboutFoundation").style.transform =
            "translate(25px,25px) rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutFoundation").style.webkitTransform =
            "translate(25px,25px) rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutImages").style.opacity = "80"
        document.getElementById("aboutImages").style.transform =
            "translate(50px,50px) rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutImages").style.webkitTransform =
            "translate(50px,50px) rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutText").style.opacity = "70"
        document.getElementById("aboutText").style.transform =
            "translate(75px,75px) rotateY(45deg) rotate(-3deg)"
        document.getElementById("aboutText").style.webkitTransform =
            "translate(75px,75px) rotateY(45deg) rotate(-3deg)"
        setTimeout(function () {
...
function sliderEffect() {
    setInterval(function () {
        let numberOfElements = document.getElementsByClassName(
            "experienceButtonLeft"
        ).length
        for (let i = 0; i < numberOfElements; i++) {
            document.getElementsByClassName("experienceButtonLeft")[
                i
            ].style.right = "15px"
            document.getElementsByClassName("experienceButtonRight")[
                i
            ].style.left = "15px"
        }
        setTimeout(function () {
